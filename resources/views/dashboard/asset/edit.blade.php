        ...
        <form class="row g-3 p-3" action="/dashboard/assets/{{ $assets->slug }}" method="POST" enctype="multipart/form-data">
          ...
          @csrf
              <div class="col-12">
                ...
                <input type="text" name="code" class="form-control @error('code') is-invalid @enderror" id="code" placeholder="Inputkan code" required value="{{ old('code', $assets->code) }}">
                @error('code')
              ...
              <div class="col-12">
                ...
                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Inputkan nama aset" required value="{{ old('name',  $assets->name )}}">
                @error('name')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
              ...
              <div class="col-12">
                ...
                <input type="text" name="price" class="form-control @error('price') is-invalid @enderror" id="price" placeholder="Inputkan harga" required value="{{ old('price', $assets->price) }}">
                @error('price')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
              ...
              <div class="col-12">
                ...
                <input type="text" name="book_value" class="form-control @error('book_value') is-invalid @enderror" id="book_value" placeholder="Inputkan nilai buku" required value="{{ old('book_value', $assets->book_value) }}">
                @error('book_value')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
              ...
              <div class="col-12">
                ...
                <input type="text" name="depreciation" class="form-control @error('depreciation') is-invalid @enderror" id="depreciation" placeholder="Inputkan penyusutan barang" required value="{{ old('depreciation', $assets->depreciation) }}">
                @error('depreciation')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
